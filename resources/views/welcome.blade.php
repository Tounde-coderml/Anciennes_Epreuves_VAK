...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="esgc-landing">
        <div class="esgc-shell">
            <header class="esgc-header">
                <div class="esgc-brand">
                    <img src="{{ asset('images/logo-esgc-vak.png') }}" alt="ESGC VAK" class="esgc-brand__logo">
                    <div>
                        <div class="esgc-brand__title">ESGC VAK</div>
                        <div class="esgc-brand__subtitle">Plateforme académique</div>
                    </div>
                </div>
                ...
                @if (Route::has('login'))
                    <nav class="esgc-nav">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="esgc-btn esgc-btn--ghost">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="esgc-btn esgc-btn--ghost">Connexion</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="esgc-btn esgc-btn--primary">Créer un compte</a>
                            @endif
                        @endauth
                    </nav>
                @endif
            ...
            <main class="esgc-hero">
                <section class="esgc-copy">
                    <span class="esgc-badge">ESGC VAK</span>
                    <h1>Accédez à vos ressources<br>et à vos épreuves.</h1>
                    <p>
                        Retrouvez les matières, les évaluations, les résultats et les informations essentielles
                        de votre parcours universitaire en toute simplicité.
                    </p>

                    <div class="esgc-actions">
                        <a href="{{ route('login') }}" class="esgc-btn esgc-btn--primary">Se connecter</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="esgc-btn esgc-btn--secondary">S’inscrire</a>
                        @endif
                    </div>

                    <div class="esgc-stats">
                        <div class="esgc-stat">
                            <strong>10+</strong>
                            <span>Filières</span>
                        </div>
                ...
                <aside class="esgc-panel" aria-label="Illustration ESGC">
                    <div class="esgc-panel__card">
                        <span class="esgc-panel__tag">Campus</span>
                        <h2>Une école qui avance</h2>
                        <p>Plateforme pensée pour accompagner les étudiants dans leur parcours.</p>
                    </div>
                </aside>
            </main>
        </div>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            body.esgc-landing {
                ...
                background: linear-gradient(135deg, #edf4fb 0%, #f7fafe 100%);
                color: var(--esgc-text);
            }
            ...
            .esgc-btn--secondary:hover,
            .esgc-btn--ghost:hover {
            ...
            .esgc-hero {
                ...
                border: 1px solid rgba(26, 95, 138, 0.08);
                border-radius: 32px;
                box-shadow: var(--esgc-shadow);
                overflow: hidden;
            }
            ...
            .esgc-panel::before {
                ...
                position: absolute;
                inset: 0;
                background: url('{{ asset('images/esgcvak.jpg') }}') center/cover no-repeat;
                opacity: 0.55;
            }
